...
namespace Literacis\CodeGenerator\Console\Command;
...
class Generate extends Command
{
    ...
    public function __construct(
        ...
        ->get(\Literacis\CodeGenerator\Model\OptionsPool::class);
    ...
    private function generate($data, $output)
    {
        ...
        ->get(\Literacis\CodeGenerator\Model\GeneratorPool::class);
