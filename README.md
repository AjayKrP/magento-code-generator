...
``` composer require Literacis/code-generator ```
...
``` php bin/magento generate:code Module_Name --type=create-view --name=Literacis_index_index --area=adminhtml --block-class=Main --template=hello.phtml --layout-type=admin-2column-left ```
