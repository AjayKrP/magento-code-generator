...
class Helper {
    ...
    public function getHeadDocBlock($moduleName)
    {
        return DocBlockGenerator::fromArray([
            'shortDescription' => 'Literacis Software.',
            'tags'             => [
                new Tag\GenericTag('category', 'Literacis'),
                new Tag\GenericTag('package', $moduleName),
                new Tag\GenericTag('author', 'Literacis'),
                new Tag\GenericTag('copyright', 'Copyright (c) Literacis Software Private Limited (https://Literacis.com)'),
                new Tag\LicenseTag('https://store.Literacis.com/license.html', '')
