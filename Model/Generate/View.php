...
namespace Literacis\CodeGenerator\Model\Generate;

use Literacis\CodeGenerator\Model\Helper;
use Literacis\CodeGenerator\Api\GenerateInterface;
use Literacis\CodeGenerator\Model\XmlGeneratorFactory;
...
class View implements GenerateInterface
{
    ...
    public function createBlock($path, $data)
    {
        ...
        if (!empty($childPaths)) {
            $childPaths = array_map(['\Literacis\CodeGenerator\Model\Generate\View', 'getClassName'], $childPaths);
